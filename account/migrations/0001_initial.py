# Generated by Django 4.1.6 on 2023-04-03 09:51
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('scan_connection', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='scan_connection', to='account.scan')),
                ('user_connection', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='user_connection', to='account.userconnection')),
            ],
        ),
    ]
